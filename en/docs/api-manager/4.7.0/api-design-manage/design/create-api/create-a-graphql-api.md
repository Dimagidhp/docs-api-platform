...
description: "Design a GraphQL API in WSO2 API Manager using an SDL schema, and understand how authorization, security, and rate limiting apply to GraphQL query, mutation, and subscription operations."
