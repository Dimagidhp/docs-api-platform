...
description: "Configure advanced endpoint settings in the WSO2 API Publisher for suspension error codes and durations, timeout retries, and connection timeout behavior for production and sandbox endpoints."
