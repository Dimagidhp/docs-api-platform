...
description: "Configure email server settings and enable notifications in the WSO2 API Manager Admin Portal so subscribers are notified automatically by email when a new version of an API is released."
