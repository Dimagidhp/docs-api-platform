...
description: "Use the WSO2 API Controller (apictl) aws init and import commands to import an API from AWS API Gateway into WSO2 API Manager's Developer Portal, and troubleshoot common import errors."
