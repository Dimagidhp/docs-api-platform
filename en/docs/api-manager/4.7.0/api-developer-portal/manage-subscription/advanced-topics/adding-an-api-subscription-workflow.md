...
description: "Attach an approval workflow to the API subscription operation in WSO2 API Manager so subscriptions remain in an ON_HOLD state until an admin or publisher approves or rejects the request."
