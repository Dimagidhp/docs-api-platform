...
description: "Configure OpenAI as a default AI Service Provider in the WSO2 API Manager admin portal, including read-only general details, editable model lists, and model-based load balancing and failover."
