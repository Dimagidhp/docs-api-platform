...
description: "Design, publish, and invoke a WebSocket-based chat API in WSO2 API Manager, including configuring channels and topics, deploying the API, and testing bidirectional messaging with the wscat client."
