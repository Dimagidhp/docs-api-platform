...
description: "Scenario tutorial on using WSO2 Micro Integrator to aggregate data from multiple third-party backends with different protocols and formats into a single API response, and publishing the resulting service to the API Manager Service Catalog."
