...
description: "An overview of user management concepts in WSO2 API Manager, covering users, permissions, and user roles, and how these building blocks are used to control access to the system."
