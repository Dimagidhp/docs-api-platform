...
description: "Use the TCPMon utility bundled with WSO2 API Manager to monitor TCP-based messages, send requests to web services, and run TCPMon as a proxy for debugging purposes."
