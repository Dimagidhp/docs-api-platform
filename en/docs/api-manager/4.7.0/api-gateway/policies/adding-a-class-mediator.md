...
description: "Write a custom Java class mediator by extending AbstractMediator to customize an API's mediation flow, package it as a policy XML file, and attach it to a request or response flow."
