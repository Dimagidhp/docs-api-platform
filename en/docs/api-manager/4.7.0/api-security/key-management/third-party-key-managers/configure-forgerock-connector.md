...
description: "Set up ForgeRock as a third-party Key Manager in WSO2 API Manager, covering ForgeRock OAuth2 provider and client configuration and adding the connector details in the Admin Portal."
