...
description: "Enable a Global Key Manager in WSO2 API Manager so a single token generated by one key manager can invoke APIs across tenants, including a full walkthrough of setting up cross-tenant subscriptions."
