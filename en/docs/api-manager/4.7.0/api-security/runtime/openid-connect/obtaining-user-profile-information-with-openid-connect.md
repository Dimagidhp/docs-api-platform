...
description: "Use OpenID Connect with WSO2 API Manager to obtain user profile information by requesting the openid scope, then either decoding the returned id_token JWT or invoking the userinfo endpoint."
