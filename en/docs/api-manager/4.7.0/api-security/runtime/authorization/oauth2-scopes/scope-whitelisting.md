...
description: "Configure scope allowlisting in WSO2 API Manager so specific OAuth2 scopes (such as openid or device_ scopes) can be issued in access tokens without requiring an associated user role."
