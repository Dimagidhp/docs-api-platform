...
description: "Enable distributed tracing in WSO2 API Manager using OpenTracing, configuring Jaeger, Zipkin, and log tracers via deployment.toml, and implementing a custom tracer such as Elastic APM."
