...
description: "Optimize apictl's Git integration feature by enabling project deletion via VCS deploy and externalizing the vcs_config.yaml state file to a custom path for container-based build systems."
