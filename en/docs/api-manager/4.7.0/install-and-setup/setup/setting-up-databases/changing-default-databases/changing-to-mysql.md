...
description: "Replace the default embedded H2 database with MySQL in WSO2 API Manager: create case-sensitive databases and users, install the MySQL connector, run the mysql.sql scripts, and configure the shared_db and apim_db datasource connections in deployment.toml."
