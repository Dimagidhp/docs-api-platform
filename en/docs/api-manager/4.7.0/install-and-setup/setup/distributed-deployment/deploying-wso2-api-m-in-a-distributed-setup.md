...
description: "Deploy WSO2 API Manager in a distributed setup with the API Control Plane, Classic Gateway, and Traffic Manager running as separate nodes for high availability."
