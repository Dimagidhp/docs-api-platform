...
description: "Connect Okta as a third-party identity provider to WSO2 API Manager using SAML 2.0, covering Okta SAML application setup, custom user attributes, API Manager role and scope mapping, identity provider configuration, and Just-in-Time provisioning."
