...
description: "Change the default root context of WSO2 API Manager so it directs to the Developer Portal instead of the Publisher by editing the component.xml file of the styles bundle."
