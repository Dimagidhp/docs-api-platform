...
description: "Steps to remove stale application data left in WSO2 API Manager when an OAuth application create or delete operation partially fails between the API Manager and Key Manager nodes."
