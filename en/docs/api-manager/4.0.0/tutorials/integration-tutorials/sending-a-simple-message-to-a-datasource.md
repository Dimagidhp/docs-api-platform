...
2. Enter the request information as given below and click the <b>Send</b> icon (<img src="../../assets/img/integrate/tutorials/119132155/play-head-icon.png" width="20">).
