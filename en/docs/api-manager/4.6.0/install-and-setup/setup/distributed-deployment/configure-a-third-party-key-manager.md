...
Therefore when required to validate a token, the Universal Gateway uses the in-memory data store and validates the token details. For more information, see [Key Manager](../../../get-started/apim-architecture/#key-manager).
...
- [Integration with a third-party OAuth Authorization Server](../../../api-security/key-management/third-party-key-managers/overview/)
