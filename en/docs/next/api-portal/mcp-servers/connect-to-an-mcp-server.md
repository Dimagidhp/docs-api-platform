...
canonical_url: https://wso2.com/api-platform/docs/cloud/api-portal/mcp-servers/connect-to-an-mcp-server/
md_url: https://wso2.com/api-platform/docs/cloud/api-portal/mcp-servers/connect-to-an-mcp-server.md
tags:
  - cloud
  - api-portal
  - mcp
...
- [Discover MCP Servers](discover-mcp-servers.md): find a server and read its tools
