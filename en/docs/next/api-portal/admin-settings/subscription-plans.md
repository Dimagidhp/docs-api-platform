...
canonical_url: https://wso2.com/api-platform/docs/cloud/api-portal/admin-settings/subscription-plans/
md_url: https://wso2.com/api-platform/docs/cloud/api-portal/admin-settings/subscription-plans.md
tags:
  - cloud
  - api-portal
  - subscription-plans
