...
canonical_url: https://wso2.com/api-platform/docs/cloud/api-portal/admin-settings/manage-views/
md_url: https://wso2.com/api-platform/docs/cloud/api-portal/admin-settings/manage-views.md
tags:
  - cloud
  - api-portal
  - views
