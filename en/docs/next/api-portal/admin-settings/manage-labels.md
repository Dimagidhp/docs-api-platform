...
canonical_url: https://wso2.com/api-platform/docs/cloud/api-portal/admin-settings/manage-labels/
md_url: https://wso2.com/api-platform/docs/cloud/api-portal/admin-settings/manage-labels.md
tags:
  - cloud
  - api-portal
  - labels
