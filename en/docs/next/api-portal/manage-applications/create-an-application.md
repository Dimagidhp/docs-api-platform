...
description: "Create an application in the API Portal & MCP Hub to hold the OAuth2 client IDs used for OAuth2-secured APIs."
canonical_url: https://wso2.com/api-platform/docs/cloud/api-portal/manage-applications/create-an-application/
md_url: https://wso2.com/api-platform/docs/cloud/api-portal/manage-applications/create-an-application.md
tags:
  - cloud
  - api-portal
  - applications
...
An application is a logical representation of a physical application — a mobile app, web app, device, or CLI tool. In the API Portal & MCP Hub, applications are used to link OAuth2 client IDs, created directly in a key manager, for invoking OAuth2-secured APIs.
