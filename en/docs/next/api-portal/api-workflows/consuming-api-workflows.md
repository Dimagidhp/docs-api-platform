---
title: "Consume API workflows in the API Portal & MCP Hub"
description: "Discover and follow published API workflows as a developer or AI agent using the API Portal UI, llms.txt, and Arazzo specifications."
canonical_url: https://wso2.com/api-platform/docs/cloud/api-portal/api-workflows/consuming-api-workflows/
md_url: https://wso2.com/api-platform/docs/cloud/api-portal/api-workflows/consuming-api-workflows.md
tags:
  - cloud
  - api-portal
  - api-workflows
