...
description: "The key building blocks of the API Portal & MCP Hub — organizations, views, APIs, subscription plans, applications, subscriptions, API keys, and more — and how they relate to each other."
