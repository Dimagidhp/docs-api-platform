...
description: "Search published APIs in the API Portal & MCP Hub by name, type, version, or description."
...
You can search for APIs in the API Portal & MCP Hub that have already been published from API Platform.
